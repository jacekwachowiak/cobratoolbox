...
% equations f(x) = 0, x in R^m using the nonlinear unconstrained minimization
% min  psi(x) = 1/2 ||f(x)||^2 s.t. x in R^m.
%
% USAGE:
%
...
%                     * 5 : stop if (default) ||hxk||<=epsilon or MaxNumIter is reached
%
% OUTPUT:
